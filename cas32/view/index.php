        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="../view/routes.php?page=showhome">Articles<span class="sr-only">(current)</span></a>
                </li>
            ...
            <span class="text-white"><?php if (!empty($_SESSION['cart'])) {
            $counter = count($_SESSION['cart']);
            echo $msg."&nbsp;<a href='routes.php?page=showcart'><i class='fas fa-cart-arrow-down' style='font-size:25px;color:red'></a></i>&nbsp;  " . $counter; //  &#128722
            } ?>&nbsp;&nbsp;</span>
            ...
            <table class="table table-muted text-center table-sm">
               ...
               <tbody>
                ...
                foreach ($allarticles as $article) {
                    ?>
                <tr>
                    <th><img src="../images/<?php echo $article['image'] ?>" width="80" /></th>
