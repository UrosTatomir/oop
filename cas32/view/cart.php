...
<div class="container-fluid">
  <div class="container mt-5 mb-5 p-4 text-center">
    ...
    <table class="table table-muted text-center table-sm" >
     ...
     <tbody>
       <tr>
        ...
        foreach ($cart as $article) {
            ?>
        <td><img src="../images/<?php echo $article['image'] ?>" width="90" /></td>
     ...
     <?php }else{ ?>
     <form action="routes.php" >
        <button type="submit"  name="page" value="showhome" class="btn btn-primary">Continue shopping</button>
     </form>
      <?php } ?>
    </div><!--end container col-8-->
  </div><!--end container-->
</div>
        <!--end container-fluid-->
