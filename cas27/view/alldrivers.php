        ...
        <table class="table table-dark text-center table-sm">
            ...
            <tbody>
                ...
                foreach ($alldrivers as $value) {
                    ...
                    echo "<td><a class='btn btn-info btn-sm btn-block' href='routes.php?page=showeditdriver&idvozaca=$value[idvozaca]'>Edit</a></td>";  //pod navodnicima "" mogu navodnici ''
                    echo "<td><a class='btn btn-danger btn-sm btn-block' href='routes.php?page=deletedriver&idvozaca=$value[idvozaca]'>Delete</a></td>";
                    echo "</tr>";
                }
                ?>
            </tbody>
