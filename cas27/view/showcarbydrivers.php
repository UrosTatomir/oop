...
<div class="container" >
    <div class="container mt-5 p-5 col-9">
   ...
   //jedan od nacina stampe tabele
                foreach ($allcardrivers as $value) {
                    ...
                    echo "<td><a class='btn btn-info' href='routes.php?page=showeditdriver&idvozaca=$value[idvozaca]'>Edit</a></td>";  //pod navodnicima "" mogu navodnici ''
                    echo "<td><a class='btn btn-danger' href='routes.php?page=deletedriver&idvozaca=$value[idvozaca]'>Delete</a></td>";
                    echo "</tr>";
                }
                ?>
            </tbody>
