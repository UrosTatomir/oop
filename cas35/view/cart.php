    ...
    <nav class="navbar fixed-top navbar-expand-lg  navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="form-inline my-2 my-lg-0">
                ...
                if(!empty($_SESSION['loggedin']) && !empty($loggedin['firstname'])){ //na ovaj nacin resen problem undefind variable
                  echo "Logged in : " . $loggedin['firstname'];
                 } ?>&nbsp;&nbsp;</span>
                ...
                <div class="row">
                    ...
                    <div class="col-4 text-left">
                        <form action="routes.php" method="post">
                            <button type="submit" name="page" value="order" class="btn btn-warning">Order</button>
                        </form>
                    </div>
