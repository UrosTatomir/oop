        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <?php if (!empty($_SESSION['user']) && !empty($user['admin'] == 1)) {  ?>
                    ...
                    <li>
                        <a class="nav-link" href="routes.php?page=showallorders">Show all orders<span class="sr-only">(current)</span></a>
                    </li>
                <?php } ?>
            </ul>
            ...
            <table class="table table-muted text-center">
                ...
                <tbody>
                    ...
                    foreach ($allarticles as $article) {
                        ?>
                        <tr>
                            <th><img src="../images/<?php echo $article['image'] ?>" width="140" height="110" /></th>
                            <th><?php echo $article['brand']; ?></th>
                            <th><?php echo $article['model']; ?><br><br><?php echo $article['description']; ?></th>
                            <!-- <th></th> -->
                            <th><?php echo $article['price']; ?> &#8364;<br><br><a class="btn btn-outline-info btn-sm" href="routes.php?page=details&idart=<?php echo $article['idart']; ?>">More details</a></th>

                            <th><br><a href="routes.php?page=addtocart&idart=<?php echo $article['idart']; ?>"><i class='fas fa-cart-arrow-down' style="font-size:35px;color:green"></i></a></th>
                        </tr>
                    <?php
                } ?>
                </tbody>
