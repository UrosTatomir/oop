...
class DB{
    ...
    {
        $settings['dbname'] = 'oopcas12';
        $settings['dbhost'] = '127.0.0.1'; //localhost
...
//primarni kljuc osigurava da vrednosti ukoloni budu jedinstvene i da nesme biti null nesme biti kopija
?>
