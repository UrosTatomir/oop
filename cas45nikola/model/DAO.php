...
private $INSERTPRODUCT="INSERT INTO articles (brand,model,description,price,image) VALUES(?,?,?,?,?)";
...
public function getAllArticles(){
   ...
   public function getAllOrders(){
      ...
      public function deleteOrder($on){
         $statement = $this->db->prepare($this->DELETEORDER);
         $statement->bindValue(1,$on);
         $statement->execute();
       }

       public function insertProduct($brand,$model,$desc,$price,$img){
