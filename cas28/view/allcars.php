        ...
        <table class="table table-dark text-center table-sm">
            ...
            // if (isset($car['idvozila'])) $car['idvozila'];
                ...
                foreach ($allcars as $car) {
                    ...
                    echo "<td>$car[cena]</td>";
                    echo "<td ><a class='btn btn-info btn-sm btn-block' href='routes.php?page=showeditcar&idvozila=$car[idvozila]'>&check;</a></td>";  //pod navodnicima "" mogu  ''
                    echo "<td><a class='btn btn-danger btn-sm btn-block ' href='routes.php?page=deletecar&idvozila=$car[idvozila]'>&cross;</a></td>";
