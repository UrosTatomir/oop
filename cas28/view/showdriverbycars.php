...
<div class="container p-5" >
    <div class="container col-9 mt-5 mb-5 p-4 text-center bg-dark text-white">
   ...
   //jedan od nacina stampe tabele
                foreach ($allcarsdriver as $value) {
                    ...
                    echo "<td><a class='btn btn-info' href='routes.php?page=showeditcar&idvozila=$value[idvozila]'>Edit</a></td>";  //pod navodnicima "" mogu navodnici ''
                    echo "<td><a class='btn btn-danger'  href='routes.php?page=deletecar&idvozila=$value[idvozila]'>Delete</a></td>";
                    echo "</tr>";
                }
                ?>
            </tbody>
