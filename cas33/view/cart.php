    ...
    <div class="container-fluid">
        <div class="container mt-5 mb-5 p-4 text-center">
            <div class="container mt-5 p-5 col-8">
                        ...
                        <tr>
                            ...
                            foreach ($cart as $article) {
                                ...
                                <!-- <form action="route.php" method="get">
                                    <td><input type="number" class="btn btn-light btn-sm" name="quantity"></td>
                                    <td><input type="submit" class="btn btn-light btn-sm" name="page" value="articletotal"></td>
                                </form> -->
                                <td>1</td>
                                <td><?php echo $article['price']; ?></td>
                ...
                <form action="routes.php">
                    <button type="submit" name="page" value="showindex" class="btn btn-primary">Continue shopping</button>
                </form>
