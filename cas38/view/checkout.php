...
<div class="container col-6 mt-5 p-5 mb-5">
 ...
 <form action="routes.php" method="post">
     ...
     <textarea class="form-control"><?php echo $user['adress']; ?></textarea><br>
     <button class="btn btn-success btn-lg" type="submit" name="page" value="Order">Order</button>
 </form>  
</div><!--end container--> 
