...
<body style="background:linear-gradient(to top,gray,white) no-repeat fixed center;">
   ...
   //jedan od nacina stampe tabele
                        foreach ($allcarsdriver as $value) {
                            ...
                            echo "<td><a class='btn btn-info' href='routes.php?page=showeditcar&idvozila=$value[idvozila]'>&#9998;</a></td>";  //pod navodnicima "" mogu navodnici ''
                            echo "<td><a class='btn btn-danger'  href='routes.php?page=deletecar&idvozila=$value[idvozila]'>&cross;</a></td>";
                            echo "</tr>";
                        }
                        ?>
                    </tbody>
