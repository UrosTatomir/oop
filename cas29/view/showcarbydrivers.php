...
<body style="background:linear-gradient(to top,gray,white) no-repeat fixed center;">
   ...
   //jedan od nacina stampe tabele
                        foreach ($allcardrivers as $value) {
                            ...
                            echo "<td><a class='btn btn-info' href='routes.php?page=showeditdriver&idvozaca=$value[idvozaca]'>&#9998;</a></td>";  //pod navodnicima "" mogu navodnici ''
                            echo "<td><a class='btn btn-danger' href='routes.php?page=deletedriver&idvozaca=$value[idvozaca]'>&cross;</a></td>";
                            echo "</tr>";
                        }
                        ?>
                    </tbody>
