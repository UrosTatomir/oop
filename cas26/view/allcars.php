        ...
        <table class="table table-dark text-center table-sm">
            ...
            // if (isset($car['idvozila'])) $car['idvozila'];
                ...
                foreach ($allcars as $car) {
                    ...
                    echo "<td>$car[cena]</td>";
                    echo "<td ><a class=text-warning href='routes.php?page=showeditcar&idvozila=$car[idvozila]'>Edit</a></td>";  //pod navodnicima "" mogu navodnici ''
                    echo "<td><a class=text-danger href='routes.php?page=deletecar&idvozila=$car[idvozila]'>Delete</a></td>";
