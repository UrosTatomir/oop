    ...
    public function isplataTekuci($iznos){
       ...
       if($iznos<=$stanjelimit){
            ...
            if($iznos>$this->stanje){
                ...
                echo"<h4>Vas iznos je isplacen $iznos</h4>";
                echo"<h4>Usli ste u dozvoljeni minus, raspolozivo vam je jos : $this->limit , din</h4>";
            }else{// mora else uprotivnom izraz nece biti vidljiv
                $this->stanje-=$iznos; //oduzimamo sredstva od glavnice 
                echo "<h4>Vas iznos $iznos sa tekuceg racuna je isplacen, novo stanje : $this->stanje ,din</h4>";
            } 
